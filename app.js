...
class Bd{
	...
	carregarTodosRegistros(){
		...
		for(let i = 1; i <= id; i++){
			...
			//existe a possibilidade de haver ídices que foram pulados/removidos
			//nestes caso nos vamos pular esse índices
	...
	pesquisar(despesa){
		let despesasFiltrada = this.carregarTodosRegistros()
